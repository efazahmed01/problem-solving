...
You have to print the sum of the array after all those operations. But you need to chose index wisely such that after doing q operations,
the sum becomes minimum possible.
